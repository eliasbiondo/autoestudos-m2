...
function execute(db){
    return db.exec(`
        ...
        INSERT OR IGNORE INTO Experiencia_profissional("titulo","local","periodo","descricao") VALUES("Auxiliar administrativo","Frango Granjeiro","Jan 2018 - Mai 2019","Atendimento ao público e serviços administrativos em geral");
    `)
}
